...
tumorsuppressors<-cntsstat[cntsstat$Ratio<0.01 & cntsstat$Patient.x>100,]
changeofF<-cntsstat[cntsstat$Ratio>0.1 & cntsstat$Patient.x>50,]
plot(changeofF$Patient.x,changeofF$Patient.y,log="xy",main="Large vs small frameshift events in the same genes",
     xlab="Small frameshifts",ylab="Large frameshifts")
cor(changeofF$Patient.x,changeofF$Patient.y)
plot(tumorsuppressors$Patient.x,tumorsuppressors$Patient.y)
cor(tumorsuppressors$Patient.x,tumorsuppressors$Patient.y)
...
#Check what p53 looks like
examples<-c("TP53","KRAS","RARA","BRD4","IDH1","ARID1A","RUNX1","PLEKHA6","STK11","SOX9","TMSB15A","TMEM97")
